...
(function (can, $) {
  ...
  defaults: {
    content_view: GGRC.mustache_path + '/help/help_modal_content.mustache', header_view: GGRC.mustache_path + '/help/help_modal_header.mustache', model: CMS.Models.Help, edit_btn_active: false
  }
}, {
  init: function () {
