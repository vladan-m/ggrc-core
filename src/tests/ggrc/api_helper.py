...
class Api():
  ...
  def send_request(self, request, obj, data, additional_headers={}, api_link=None):
    if api_link is None:
  ...
  def put(self, obj, data):
    ...
    return self.send_request(self.tc.put , obj, data, additional_headers=headers, api_link=api_link)
