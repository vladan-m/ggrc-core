...
(function (can, $) {
  ...
  var COLLAPSE = 'collapse', LHN_SIZE = 'lhn_size', OBJ_SIZE = 'obj_size', SORTS = 'sorts', HEIGHTS = 'heights', COLUMNS = 'columns', PBC_LISTS = 'pbc_lists', GLOBAL = 'global', LHN_STATE = 'lhn_state', TOP_NAV = 'top_nav', FILTER_WIDGET = 'filter_widget', TREE_VIEW_HEADERS = 'tree_view_headers', TREE_VIEW = 'tree_view', CHILD_TREE_DISPLAY_LIST = 'child_tree_display_list', MODAL_STATE = 'modal_state', path = window.location.pathname.replace(/\./g, '/');

  can.Model.LocalStorage('CMS.Models.DisplayPrefs', {
  autoupdate: true, version: 20150129 // Last updated to add 2 accessors
  ...
  , resetPagePrefs: function () {
    ...
    can.each(
      ['open_category', 'panel_scroll', 'category_scroll', 'search_text', 'my_work', 'filter_params', 'is_open', 'is_pinned'], function (token) {
  ...
  CMS.Models.DisplayPrefs.exports = {
    COLLAPSE: COLLAPSE, SORTS: SORTS, HEIGHTS: HEIGHTS, COLUMNS: COLUMNS, GLOBAL: GLOBAL, PBC_LISTS: PBC_LISTS, path: path
  };
}
