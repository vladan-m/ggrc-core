...
def update_workflow_state(workflow):
  ...
  next_cycle_end_date = WorkflowDateCalculator.adjust_end_date(
      workflow.frequency, calculator.nearest_end_date_after_start_date(next_cycle_start_date))

  # Check the previous cycle to see if today is mid_cycle.
  previous_cycle_start_date = WorkflowDateCalculator.adjust_start_date(
      workflow.frequency, calculator.previous_cycle_start_date_before_basedate(today))
  previous_cycle_end_date = WorkflowDateCalculator.adjust_end_date(
      workflow.frequency, calculator.nearest_end_date_after_start_date(previous_cycle_start_date))
