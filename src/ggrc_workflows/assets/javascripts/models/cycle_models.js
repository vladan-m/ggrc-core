...
(function (can) {
  ...
  _mustachePath = GGRC.mustache_path + '/cycle_task_group_objects';
  ...
  can.Model.Cacheable('CMS.Models.CycleTaskGroupObjectTask', {
    ...
    permalink_options: {
      url:
        '<%= base.viewLink %>#current_widget' +
        '/cycle/<%= instance.cycle.id %>/cycle_task_group' +
        '/<%= instance.cycle_task_group.id %>/' +
    ...
    tree_view_options: {
      ...
      attr_list: [
        ...
        {
          attr_title: 'Mapped Object',
          attr_name: 'mapped_object',
          attr_sort_field: 'cycle_task_group_object.title'
        },
        {
          attr_title: 'Workflow',
          attr_name: 'workflow',
    ...
    init: function () {
      ...
      this.bind('updated', function (ev, instance) {
        if (instance instanceof that) {
          instance.refresh_all_force(
            'cycle_task_group_object', 'task_group_object', 'object'
