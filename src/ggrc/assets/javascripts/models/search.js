...
can.Model('GGRC.Models.Search', {
  ...
  findOne: 'GET /search', search: function (str, params) {
    ...
    return $.when.apply($, dfds).then(function () {
      var model_results = can.makeArray(arguments), search_response = {entries: {}, selfLink: 'Fake'}
        ;
  ...
  getResultsFor: function (type) {
    ...
    var model = CMS.Models[model_name], entries;
