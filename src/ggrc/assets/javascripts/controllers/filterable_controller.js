...
(function (can, $) {
  ...
  defaults: {
    filterable_items_selector: '[data-model]', spinner_while_filtering: false, spinner_style: {
      top: 100, left: 100, height: 50, width: 50, position: 'absolute'
    }
  }
  //static
}, {
  filter: function (str, extra_params, dfd) {
    var that = this, spinner, search_dfds = str ? [GGRC.Models.Search.search(str, extra_params)] : [$.when(null)];
