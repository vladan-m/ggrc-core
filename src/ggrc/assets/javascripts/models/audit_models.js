...
(function (can) {
  ...
  can.Model.Cacheable('CMS.Models.Audit', {
    root_object: 'audit', root_collection: 'audits', category: 'programs', findAll: 'GET /api/audits', findOne: 'GET /api/audits/{id}', update: 'PUT /api/audits/{id}', destroy: 'DELETE /api/audits/{id}', create: 'POST /api/audits', mixins: ['contactable', 'unique_title'], is_custom_attributable: true, attributes: {
    context: 'CMS.Models.Context.stub', program: 'CMS.Models.Program.stub', requests: 'CMS.Models.Request.stubs', modified_by: 'CMS.Models.Person.stub', start_date: 'date', end_date: 'date', report_start_date: 'date', report_end_date: 'date', object_people: 'CMS.Models.ObjectPerson.stubs', people: 'CMS.Models.Person.stubs', audit_firm: 'CMS.Models.OrgGroup.stub', audit_objects: 'CMS.Models.AuditObject.stubs', custom_attribute_values: 'CMS.Models.CustomAttributeValue.stubs'
  }, defaults: {
    status: 'Draft',
    ...
    header_view: GGRC.mustache_path + '/audits/tree_header.mustache', attr_list: [
    ...
    ], draw_children: true, child_options: [{
      model: 'Request', mapping: 'requests', allow_creating: true, parent_find_param: 'audit.id'
    },
    {
      model: 'Request', mapping: 'related_owned_requests', allow_creating: true, parent_find_param: 'audit.id'
    },
    {
      model: 'Response', mapping: 'related_owned_responses', allow_creating: false, parent_find_param: 'audit.id'
    },
    {
      model: 'Request', mapping: 'related_mapped_requests', allow_creating: false, parent_find_param: 'audit.id'
    },
    {
      model: 'Response', mapping: 'related_mapped_responses', allow_creating: false, parent_find_param: 'audit.id'
    }]
  }, init: function () {
      ...
      $.map(loader.list, function (binding) {
        ...
        function checkRole() {
          if (role.attr('name') === 'Auditor') {
            auditors_list.push({
              person: binding.instance.person.reify(), binding: binding.instance
            });
          }
        }
        if (role.selfLink) {
      ...
      $.map(loader.list, function (binding) {
        ...
        dfds.push(new $.Deferred(function (dfd) {
          ...
          function checkRole() {
            if (role.attr('name') === 'Auditor') {
              auditors_list.push({
                person: instance.person.reify(), binding: instance
              });
            }
          }
          if (role.selfLink) {
  ...
  can.Model.Cacheable('CMS.Models.Request', {
    ...
    root_collection: 'requests', findAll: 'GET /api/requests', findOne: 'GET /api/requests/{id}', create: 'POST /api/requests', update: 'PUT /api/requests/{id}', destroy: 'DELETE /api/requests/{id}', mixins: ['unique_title'], is_custom_attributable: true, attributes: {
    context: 'CMS.Models.Context.stub', assignee: 'CMS.Models.Person.stub', requested_on: 'date', due_on: 'date', documents: 'CMS.Models.Document.stubs', audit: 'CMS.Models.Audit.stub', custom_attribute_values: 'CMS.Models.CustomAttributeValue.stubs'
  }, defaults: {
    status: 'Open',
    ...
    show_view: GGRC.mustache_path + '/requests/tree.mustache', header_view: GGRC.mustache_path + '/requests/tree_header.mustache', footer_view: GGRC.mustache_path + '/requests/tree_footer.mustache', add_item_view: GGRC.mustache_path + '/requests/tree_add_item.mustache', attr_list: [
      {attr_title: 'Title', attr_name: 'title'},
      {attr_title: 'Status', attr_name: 'status'},
      {attr_title: 'Last Updated', attr_name: 'updated_at'},
    ...
    ], display_attr_names: ['title', 'assignee', 'due_on', 'status', 'request_type'], mandatory_attr_names: ['title'], draw_children: true, child_options: [{
      model: can.Model.Cacheable,
      mapping: 'info_related_objects',
      allow_creating: true,
    }]
  ...
  init: function () {
    ...
    var desc = this.title, max_len = 20;
    out_name = desc;
  ...
  can.Model.Cacheable('CMS.Models.Response', {
    root_object: 'response', root_collection: 'responses', subclasses: [], init: function () {
    this._super && this._super.apply(this, arguments);
    ...
    this.validatePresenceOf('contact');
  }, create: 'POST /api/responses', update: 'PUT /api/responses/{id}', findAll: 'GET /api/responses', findOne: 'GET /api/responses/{id}', destroy: 'DELETE /api/responses/{id}', model: function (params) {
    var found = false;
    ...
    context: 'CMS.Models.Context.stub', object_documents: 'CMS.Models.ObjectDocument.stubs', documents: 'CMS.Models.Document.stubs', population_worksheet: 'CMS.Models.Document.stub', sample_worksheet: 'CMS.Models.Document.stub', sample_evidence: 'CMS.Models.Document.stub', object_people: 'CMS.Models.ObjectPerson.stubs', people: 'CMS.Models.Person.stubs', meetings: 'CMS.Models.Meeting.stubs', request: 'CMS.Models.Request.stub', related_sources: 'CMS.Models.Relationship.stubs', related_destinations: 'CMS.Models.Relationship.stubs', controls: 'CMS.Models.Control.stubs', contact: 'CMS.Models.Person.stub'
  }, defaults: {
    status: 'Assigned'
  }, tree_view_options: {
    show_view: GGRC.mustache_path + '/responses/tree.mustache', add_item_view: GGRC.mustache_path + '/responses/tree_add_item.mustache', draw_children: true, child_options: [{
      //0: mapped objects
      mapping: 'business_objects', model: can.Model.Cacheable, show_view: GGRC.mustache_path + '/base_objects/tree.mustache', footer_view: GGRC.mustache_path + '/base_objects/tree_footer.mustache', add_item_view: GGRC.mustache_path + '/base_objects/tree_add_item.mustache', allow_mapping: false, allow_creating: false, exclude_option_types: function () {
        var types = {
          'DocumentationResponse': 'Document', 'InterviewResponse': 'Person'
        };
        return types[this.parent_instance.constructor.shortName] || '';
      }
    }, {
      //1: Document Evidence
      model: 'Document', mapping: 'documents', show_view: GGRC.mustache_path + '/documents/pbc_tree.mustache', allow_mapping: false, allow_creating: false
    }, {
      //3: Meeting participants
      model: 'Person', mapping: 'people', show_view: GGRC.mustache_path + '/people/tree.mustache', footer_view: GGRC.mustache_path + '/people/tree_footer.mustache', add_item_view: GGRC.mustache_path + '/people/tree_add_item.mustache', allow_mapping: false, allow_creating: false
    }, {
      //2: Meetings
      model: 'Meeting', mapping: 'meetings', show_view: GGRC.mustache_path + '/meetings/tree.mustache', footer_view: GGRC.mustache_path + '/meetings/tree_footer.mustache', add_item_view: GGRC.mustache_path + '/meeting/tree_add_item.mustache', allow_mapping: false, allow_creating: false
    }]
  }
  }, {
  display_name: function () {
    var desc = this.description, max_len = 20, out_name = desc;
      // Truncate if greater than max_len chars
    if (desc.length > max_len) {
        out_name = desc.slice(0, max_len) + ' ...';
      }
  ...
  CMS.Models.Response('CMS.Models.DocumentationResponse', {
    root_object: 'documentation_response', root_collection: 'documentation_responses', create: 'POST /api/documentation_responses', update: 'PUT /api/documentation_responses/{id}', findAll: 'GET /api/documentation_responses', findOne: 'GET /api/documentation_responses/{id}', destroy: 'DELETE /api/documentation_responses/{id}', attributes: {}, init: function () {
    this._super && this._super.apply(this, arguments);
  ...
  CMS.Models.Response('CMS.Models.InterviewResponse', {
    root_object: 'interview_response', root_collection: 'interview_responses', create: 'POST /api/interview_responses', update: 'PUT /api/interview_responses/{id}', findAll: 'GET /api/interview_responses', findOne: 'GET /api/interview_responses/{id}', destroy: 'DELETE /api/interview_responses/{id}', attributes: {}, init: function () {
    this._super && this._super.apply(this, arguments);
    can.extend(this.attributes, CMS.Models.Response.attributes);
    this.cache = CMS.Models.Response.cache;
  }, process_args: function (args, names) {
  ...
  save: function () {
    var that = this;
    if (this.isNew()) {
      var audit = this.request.reify().audit.reify(), auditors_dfd = audit.findAuditors();
  ...
  CMS.Models.Response('CMS.Models.PopulationSampleResponse', {
    root_object: 'population_sample_response', root_collection: 'population_sample_responses', create: 'POST /api/population_sample_responses', update: 'PUT /api/population_sample_responses/{id}', findAll: 'GET /api/population_sample_responses', findOne: 'GET /api/population_sample_responses/{id}', destroy: 'DELETE /api/population_sample_responses/{id}', attributes: {}, init: function () {
    this._super && this._super.apply(this, arguments);
    can.extend(this.attributes, CMS.Models.Response.attributes);
    this.cache = CMS.Models.Response.cache;
  }, process_args: function (args, names) {
  ...
  can.Model.Cacheable('CMS.Models.Meeting', {
    root_collection: 'meetings', root_object: 'meeting', findAll: 'GET /api/meetings', create: 'POST /api/meetings', update: 'PUT /api/meetings/{id}', destroy: 'DELETE /api/meetings/{id}', attributes: {
    context: 'CMS.Models.Context.stub', response: 'CMS.Models.Response.stub', people: 'CMS.Models.Person.stubs', object_people: 'CMS.Models.ObjectPerson.stubs', start_at: 'datetime', end_at: 'datetime'
