...
(function (can, $) {
  ...
  init: function () {
    ...
    can.each(this.constructor.join_keys, function (cls, key) {
      ...
      var object_id = this[attr + '_id'] || (this[attr] || {}).id, object_type = this[attr + '_type'] || (this[attr] || {}).type
        ;

      if (object_id && object_type && typeof object_type === 'string') {
        this.attr(attr, CMS.Models.get_instance(
              object_type, object_id, this[attr]
            ) || this[attr]);
      } else if (object_id) {
  ...
  root_object: 'relationship', root_collection: 'relationships', attributes: {
    context: 'CMS.Models.Context.stub', modified_by: 'CMS.Models.Person.stub', source: 'CMS.Models.get_stub', destination: 'CMS.Models.get_stub'
  }, join_keys: {
    source: can.Model.Cacheable, destination: can.Model.Cacheable
  }, defaults: {
    source: null, destination: null
  }, findAll: 'GET /api/relationships', create: 'POST /api/relationships', update: 'PUT /api/relationships/{id}', destroy: 'DELETE /api/relationships/{id}', get_relationship: function (source, destination) {
      ...
      this.source_type ||
        (this.source &&
            (this.source.constructor &&
                ...
                (!this.source.selfLink && this.source.type))), this.source_id || (this.source && this.source.id), this.source) || this.source);
      ...
      this.destination_type ||
        (this.destination &&
            (this.destination.constructor &&
                ...
                (!this.source.selfLink && this.destination.type))), this.destination_id || (this.destination && this.destination.id), this.destination) || this.destination);
  }
});

  can.Model.Join('CMS.Models.UserRole', {
  root_object: 'user_role', root_collection: 'user_roles', findAll: 'GET /api/user_roles', update: 'PUT /api/user_roles/{id}', create: 'POST /api/user_roles', destroy: 'DELETE /api/user_roles/{id}', attributes: {
    context: 'CMS.Models.Context.stub', modified_by: 'CMS.Models.Person.stub', person: 'CMS.Models.Person.stub', role: 'CMS.Models.Role.stub'
  }, join_keys: {
    person: CMS.Models.Person, role: CMS.Models.Role
  }
}, {
  save: function () {
    var roles,
  ...
  root_object: 'object_person', root_collection: 'object_people', findAll: 'GET /api/object_people', create: 'POST /api/object_people', update: 'PUT /api/object_people/{id}', destroy: 'DELETE /api/object_people/{id}', join_keys: {
    personable: can.Model.Cacheable, person: CMS.Models.Person
  }, attributes: {
    context: 'CMS.Models.Context.stub', modified_by: 'CMS.Models.Person.stub', person: 'CMS.Models.Person.stub', personable: 'CMS.Models.get_stub'
  }

}, {});

  can.Model.Join('CMS.Models.ObjectOwner', {
  root_object: 'object_owner', root_collection: 'object_owners', findAll: 'GET /api/object_owners', create: 'POST /api/object_owners', update: 'PUT /api/object_owners/{id}', destroy: 'DELETE /api/object_owners/{id}', join_keys: {
    ownable: can.Model.Cacheable, person: CMS.Models.Person
  }, attributes: {
    context: 'CMS.Models.Context.stub', modified_by: 'CMS.Models.Person.stub', person: 'CMS.Models.Person.stub', ownable: 'CMS.Models.get_stub'
  }

}, {});

  can.Model.Join('CMS.Models.ObjectDocument', {
  root_object: 'object_document', root_collection: 'object_documents', findAll: 'GET /api/object_documents', create: 'POST /api/object_documents', destroy: 'DELETE /api/object_documents/{id}', join_keys: {
    documentable: can.Model.Cacheable, document: CMS.Models.Document
  }, attributes: {
    context: 'CMS.Models.Context.stub', modified_by: 'CMS.Models.Person.stub', document: 'CMS.Models.Document.stub', documentable: 'CMS.Models.get_stub'
  }
}, {});
